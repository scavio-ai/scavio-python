...
class ScavioClient:
    ...
    A unified API over Google, YouTube, Amazon, Walmart, Reddit, X,
    TikTok, TikTok Shop, Instagram, and LinkedIn. Every provider is exposed as a namespace
