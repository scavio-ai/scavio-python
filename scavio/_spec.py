...
_ENDPOINTS: tuple[Endpoint, ...] = (
    ...
    Endpoint(
        key="twitter_tweet_comments",
        namespace="twitter",
        method="tweet_comments",
        http="POST",
        path="/api/v1/twitter/tweet/comments",
    ...
    Endpoint(
        key="twitter_tweet_retweeters",
        namespace="twitter",
        method="tweet_retweeters",
        http="POST",
        path="/api/v1/twitter/tweet/retweeters",
    ...
    Endpoint(
        ...
        method="user",
        http="POST",
        path="/api/v1/twitter/user",
        summary="Profile details for a user.",
        params=(_req("screen_name", "A Twitter handle (without the @)."),),
    ),
    Endpoint(
        key="twitter_user_tweets",
        namespace="twitter",
        method="user_tweets",
        http="POST",
        path="/api/v1/twitter/user/tweets",
        summary="A user's tweets.",
        params=(
            _req("screen_name", "A Twitter handle (without the @)."),
            _str("cursor", "Pagination cursor from a prior response."),
        ),
    ),
    Endpoint(
        key="twitter_user_replies",
        namespace="twitter",
        method="user_replies",
        http="POST",
        path="/api/v1/twitter/user/replies",
    ...
    Endpoint(
        key="twitter_user_media",
        namespace="twitter",
        method="user_media",
        http="POST",
        path="/api/v1/twitter/user/media",
    ...
    Endpoint(
        key="twitter_user_followers",
        namespace="twitter",
        method="user_followers",
        http="POST",
        path="/api/v1/twitter/user/followers",
    ...
    Endpoint(
        key="twitter_user_followings",
        namespace="twitter",
        method="user_followings",
        http="POST",
        path="/api/v1/twitter/user/followings",
